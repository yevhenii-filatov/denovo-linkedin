...
class LinkedinBasicProfileInfoParserTest {
    ...
    void shouldParse(){
        ...
        LinkedinBasicProfileInfo actual = parser.parse(combinedSource).get(0);
        ...
        expected.setAbout("I am a co-founder of a software company named DataOx engaged in web scraping services and data cleansing technologies. " +
