...
create table if not exists scraping_batch
(
    id                     bigserial not null
    constraint scraping_batch_pk
    primary key,
...
(
    ...
    on delete cascade on update cascade,
    scraping_batch_id      bigint null
    constraint search_result_scraping_batch_fk
    references scraping_batch (id)
    on delete cascade on update cascade
    );
...
(
    ...
    job_type            varchar  null default null,
